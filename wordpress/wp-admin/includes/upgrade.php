...
function wp_install_defaults( $user_id ) {
	...
	//$nurseryId = $wpdb->get_results("SELECT option_value FROM wpdb->options WHERE option_name='nurseryId'");
    //$check_nursery = $wpdb->get_var("SELECT option_value FROM $wpdb->wp_78_options WHERE option_name = 'nurseryId'");
	//$nurseryId = $wpdb->blogid;
	$nursery = $wpdb->get_var( "SELECT nurseryId FROM $wpdb->blogs WHERE blog_id = $wpdb->blogid");
	$str = file_get_contents('../../cache/cache.json');
	$json = json_decode($str, true);
	//foreach($json as $nursery){
    $id = $json[1]['Id'];
    $name = $json[1]['Name'];
	//}
...
As a new WordPress user, you should go to <a href=\"%s\">your dashboard</a> to delete this page and create new pages for your content. Have fun!" ), admin_url() );
	...
	$about_post_guid = get_option('home') . '/?page_id=1';
	$wpdb->insert( $wpdb->posts, array(
					'post_author' => $user_id,
					'post_date' => $now,
					'post_date_gmt' => $now_gmt,
					'post_content' => '<p><strong>' . 'This is my about page.' . '</strong></p>' ,
					'post_excerpt' => '',
					'post_title' => __( 'About ' ),
					'post_name' => __( 'about' ),
					'post_modified' => $now,
					'post_modified_gmt' => $now_gmt,
					'guid' => $about_post_guid,
					'post_type' => 'page',
					'to_ping' => '',
					'pinged' => '',
					'post_content_filtered' => ''
					));
	$wpdb->insert( $wpdb->postmeta, array( 'post_id' => 1, 'meta_key' => '_wp_page_template', 'meta_value' => 'about-page.php' ) );

	$gallery_post_guid = get_option('home') . '/?page_id=2';
	$wpdb->insert( $wpdb->posts, array(
					'post_author' => $user_id,
					'post_date' => $now,
					'post_date_gmt' => $now_gmt,
					...
					'post_name' => __( 'gallery' ),
					'post_modified' => $now,
					'post_modified_gmt' => $now_gmt,
					'guid' => $contact_post_guid,
					'post_type' => 'page',
					'to_ping' => '',
					'pinged' => '',
					'post_content_filtered' => ''
	...
	$wpdb->insert( $wpdb->postmeta, array( 'post_id' => 2, 'meta_key' => '_wp_page_template', 'meta_value' => 'gallery-page.php' ) );

	$teachers_post_guid = get_option('home') . '/?page_id=3';
	$wpdb->insert( $wpdb->posts, array(
					'post_author' => $user_id,
					'post_date' => $now,
					'post_date_gmt' => $now_gmt,
					'post_content' => 'This is my teachers page.',
					'post_excerpt' => '',
					'post_title' => __( 'Teachers ' ),
					'post_name' => __( 'teachers' ),
					'post_modified' => $now,
					'post_modified_gmt' => $now_gmt,
					'guid' => $contact_post_guid,
					'post_type' => 'page',
	...
	$wpdb->insert( $wpdb->postmeta, array( 'post_id' => 3, 'meta_key' => '_wp_page_template', 'meta_value' => 'teachers-page.php' ) );

	$contact_post_guid = get_option('home') . '/?page_id=4';
	$wpdb->insert( $wpdb->posts, array(
					'post_author' => $user_id,
					'post_date' => $now,
					'post_date_gmt' => $now_gmt,
					'post_content' => 'This is my contact page.',
					'post_excerpt' => '',
	...
	$wpdb->insert( $wpdb->postmeta, array( 'post_id' => 4, 'meta_key' => '_wp_page_template', 'meta_value' => 'contact-page.php' ) );
